    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        ...
        <div class="flex space-x-4">
            <button type="submit" 
                    ...
                    class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white {{ $hasApprovedVacation ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700' }} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
